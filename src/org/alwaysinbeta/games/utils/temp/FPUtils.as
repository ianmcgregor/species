package org.alwaysinbeta.games.utils.temp 
{
	...
	public class FPUtils 
	{
		...
		{
			if (relative) angle += FPUtils.angle(anchor.x, anchor.y, object.x, object.y);
			FPUtils.angleXY(object, angle, FPUtils.distance(anchor.x, anchor.y, object.x, object.y), anchor.x, anchor.y);
		}
