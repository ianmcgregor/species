package org.alwaysinbeta.games.utils.temp {
	...
	public class FPKeyInput
	{
		...
		private  static var _stage : IEventDispatcher;

		public function FPKeyInput(stage: IEventDispatcher) {
			_stage = stage;
		}
		...
		private static function onKeyDown(e:KeyboardEvent = null):void
		{
			...
			if (code == Keyboard.BACKSPACE) keyString = keyString.substring(0, keyString.length - 1);
