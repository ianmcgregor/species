...
//		private var _world : World;
		...
		public function init() : void {
			...
			_menu.addChild(_title = new QuickText(100, 20, "SPECIES"));
			_menu.addChild(_body = new QuickText(200, 100, "Humans have evolved into 2 separate species. The aggressive, dominant species are keeping the good natured species imprisoned underground working for them. You lead the rebellion!"));
